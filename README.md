...
Note: for macos, you will have to build the binary as a `.dylib` in a `godotcon2024.framework` folder. The framework folder should also have a `Resources` folder with a file called `Info.plist`. Without this file, signing will fail.
...
```sh
bin/godotcon2024.macos.template_debug.framework/godotcon2024.macos.template_release
bin/godotcon2024.ios.template_debug.framework/godotcon2024.ios.template_release.arm64.dylib
